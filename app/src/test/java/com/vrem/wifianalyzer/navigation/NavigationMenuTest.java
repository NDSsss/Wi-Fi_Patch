...
public class NavigationMenuTest {
    ...
    public void testGetNavigationItem() {
        ...
        assertEquals(NavigationItemFactory.EXPORT, NavigationMenu.EXPORTHISTORY.getNavigationItem());
    ...
    public void testGetTitle() {
        ...
        assertEquals(R.string.action_export, NavigationMenu.EXPORTHISTORY.getTitle());
    ...
    public void testIsWiFiBandSwitchableFalse() {
        ...
        assertFalse(NavigationMenu.EXPORTHISTORY.isWiFiBandSwitchable());
    ...
    public void testIsRegisteredFalse() {
        ...
        assertFalse(NavigationMenu.EXPORTHISTORY.isRegistered());
    ...
    public void testGetIcon() {
        ...
        assertEquals(R.drawable.ic_import_export_grey_500_48dp, NavigationMenu.EXPORTHISTORY.getIcon());
